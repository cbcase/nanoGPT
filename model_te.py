...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            ln_f = te.LayerNorm(config.n_embd, eps=1e-5),
        ))
        self.lm_head = te.Linear(config.n_embd, config.vocab_size, bias=True)
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betas, device_type):
        ...
        decay = set()
        no_decay = set()
        whitelist_weight_modules = (torch.nn.Linear, te.Linear)
        blacklist_weight_modules = (torch.nn.LayerNorm, te.LayerNorm, torch.nn.Embedding)
